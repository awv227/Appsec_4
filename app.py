...
app.secret_key = open("CSRF_Token.txt", "r").readline()
...
admin_uname = open("admin_uname.txt", "r").readline()
admin_pword = open("admin_pword.txt", "r").readline()
admin_ID_2fa = open("admin_mfa.txt", "r").readline()
